...
// intern's grantedCapabilities (spec 11.7/11.8). Admin only (capability grants
// are account management, spec §7). The whole list is replaced, so the UI sends
// the full desired set. Audit-logged.
